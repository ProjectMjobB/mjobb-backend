...
public class SearchServiceImpl implements SearchService {
    ...
    public Page<JobAdvertisement> searchJobs(String query, Pageable pageable) {
        return jobPageableRepository.findAllByTitleContainsIgnoreCaseOrAddressContainsIgnoreCaseOrJobTypeContainsIgnoreCaseAndAccepted(query, query, query, true, pageable);    }
